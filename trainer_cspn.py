...
class Trainer:
    def __init__(self, options):
        ...
        if self.refine:
            self.set_requires_grad(self.models["encoder"])
        ...
        if self.refine:
            self.set_requires_grad(self.models["depth"])
        ...
        if self.refine:
            self.set_requires_grad(self.models["pose_encoder"])
        if self.ref_pose:
        ...
        if self.refine:
            self.set_requires_grad(self.models["pose"])
        if self.ref_pose:
